...
rem set JAVA_OPTS=%JAVA_OPTS% -Xms128m -Xmx768m
...
rem by default maxFormContentSize is set to 200kb, note jetty 6 changed this param name to another one

set JAVA_OPTS=%JAVA_OPTS% -Xmx768m -Duser.timezone=GMT+8 -Dorg.mortbay.http.HttpRequest.maxFormContentSize=10240000 -Duser.language=zh_CN -XX:MaxPermSize=256m
