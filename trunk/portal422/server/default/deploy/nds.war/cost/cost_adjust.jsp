			  ...
			  <td height="429" valign="top" background="images/var_index_bg.gif"><table width="799" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="190" valign="top"><table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="td_text"> 
                      		<input class="cbutton" type="button" value='<%= PortletUtils.getMessage(pageContext, "creat-sell-adjust",null)%>' onclick="javascript:popup_window('/html/nds/object/object.jsp?table=b_slpriceadj&fixedcolumns=&id=-1')"/>&nbsp;&nbsp;
  						</td>
                    </tr>
                  </table></td>
                  <td valign="top"><table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="td_text" >
                      	<br>
                      	<br>
                      		<input class="cbutton" type="button" value='<%= PortletUtils.getMessage(pageContext, "creat-retail-adjust",null)%>' onclick="javascript:popup_window('/html/nds/object/object.jsp?table=b_rtpadj&fixedcolumns=&id=-1')"/>&nbsp;&nbsp;
  					</td>
                    </tr>
                  </table></td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td height="150" valign="top"><table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="td_text">
                      	<input class="cbutton" type="button" value='<%= PortletUtils.getMessage(pageContext, "creat-sell-detail",null)%>' onclick="javascript:cost.createretail();"/>&nbsp;&nbsp;
						<input class="cbutton" type="button" value='<%= PortletUtils.getMessage(pageContext, "update-sell-detail",null)%>' onclick="javascript:cost.updateretail();"/>&nbsp;&nbsp;
						</td>
                    </tr>
                  </table></td>
                  <td valign="top"><table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td align="center" class="td_text"><a onclick="javascript:popup_window('/cost/cost_query.jsp')"><img src="images/pic_cx.gif" width="80" height="80" /></a></td>
                    </tr>
