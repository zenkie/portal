...
<%
	...
	//获得要查询的String对象	
	String[] selectName=request.getParameter("showdc").trim().split(",");
	...
	String rqcodedisposeid = request.getParameter("rqcodedisposeid");
	...
	for(int i=0;i<result.getRowCount();i++){
		...
		for(int j=0;j< showColumnsObjType.size();j++){
			if(j==0){
				...
				}else if(rqcodedisposeid!=null && rqcodedisposeid.equals(String.valueOf(result.getObject(j+1)))){
					tableCon.append("checked=\"checked\"");
				}
				tableCon.append("/>");
			}else{
