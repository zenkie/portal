...
<td id="q_begin_btn_<%=queryindex%>" onaction="oq.scrollPage('q_begin_btn_<%=queryindex%>')"><img src="<%=NDS_PATH%>/images/begin.gif" width="16" height="16"></td>
<td id="q_prev_btn_<%=queryindex%>" onaction="oq.scrollPage('q_prev_btn_<%=queryindex%>')"><img src="<%=NDS_PATH%>/images/back.gif" width="16" height="16"></td>
<td id="q_next_btn_<%=queryindex%>" onaction="oq.scrollPage('q_next_btn_<%=queryindex%>')"><img src="<%=NDS_PATH%>/images/next.gif" width="16" height="16"></td>
<td id="q_end_btn_<%=queryindex%>" onaction="oq.scrollPage('q_end_btn_<%=queryindex%>')"><img src="<%=NDS_PATH%>/images/end.gif" width="16" height="16"></td>
<td>
