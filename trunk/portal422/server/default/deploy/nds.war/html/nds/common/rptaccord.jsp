...
%>
	<div>
	<h3><a style="display:inline-block"><%=dk%></a></h3><div>
<%
...
%>
		<div class="accordion_headings" onclick="javascript:<%=action%>(<%=resultData.getObject(1)%>)"><img class="rpt_img" src="<%=NDS_PATH%>/images/<%=icon%>"></img><a><%=StringUtils.escapeForXML((String)resultData.getObject(2))%></a></div>
<%	}
%>
	</div></div>
<%
