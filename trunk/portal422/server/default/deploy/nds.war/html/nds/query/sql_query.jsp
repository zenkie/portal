...
<%
    /**
     * Return sql like select table.id from table where aaa=xxx and bbb=xxx, note date will be taken as string(for MySQL to accept)
     * Request parameters:
     *  1. "retur_type" "n" for none
...
<%@ include file="js/functions.js" %>
 <Script language="javascript">
  function submitQuery(theform){
  	
  	theform.submit();
  }
  function submitSQL(theform, url){
  	theform.action=url;
  	theform.resulthandler.value="/query/sql_result.jsp";
  	theform.submit();
  }
          ...
          <table width="38%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="20%" align='right'>
              	<input type="image" name="Submit" value=""  onclick='javascript:submitQuery(document.form_search);' src="../images/dosearch.gif" border=0 width=100 height=20 >
              </td>
              <td align='left' width="16%" >
                <input type="image" name="Submit" value=""  onclick='javascript:submitSQL(document.form_search,"<%= request.getContextPath()%>/servlets/QuerySQLHandler");' src="../images/generate_sql.gif" border=0 width=81 height=20 >
              </td>
            </tr>
          </table>
