...
IMClient.prototype = {
    ...
    show: function (idx) {
        ...
        if (obj.url != null) msg += "<div class='imf'><a href='" + obj.url.escapeHTML() + "'>" + gMessageHolder.VIEW_ATTACH + "</a></div>";
        if (obj.noteid != null && !isNaN(obj.noteid)) {
    ...
    */
    ...
    build: function (id) {
        ...
        if (sysMessages.length % 2 != 0) {
            htmls.push("<li class='syslist-item'><a class='imm'>&nbsp;</a></li>");
        }
        im._start = sysMessages.length;
        htmls.push('<li style="clear:both;height:0px;width:1px;"></li></ul>');
        container.style.cssText = "position:absolute;bottom:0px;left:0px;right:0px;";
        container.style.cssText = "height:" + (jQuery(".index-right-content-wrap").parent().height() - jQuery(".index-right-content-wrap").height()) + "px;";
