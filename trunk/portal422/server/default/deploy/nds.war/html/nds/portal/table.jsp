...
<div id="page-table-query">
  ...
  <div class="table-buttons">       	        	
	  <a href="javascript:pc.queryList()"><%=PortletUtils.getMessage(pageContext, "object.search",null)%></a>
	  <a href="javascript:popup_window('/html/nds/help/index.jsp?table=<%=tableId%>')"><%=PortletUtils.getMessage(pageContext, "help",null)%></a>
  </div>
