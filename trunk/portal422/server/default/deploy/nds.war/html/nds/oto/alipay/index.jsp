            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<input size="30" name="WIDseller_email" value="alipay-test09@alipay.com"/>
						<span></span>
					</dd>
					<dt>商户订单号：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDout_trade_no" value="123123" />
						<span></span>
					</dd>
					<dt>订单名称：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDsubject" value="测试1"/>
						<span></span>
					</dd>
                    <dt>付款金额：</dt>
                    <dd>
