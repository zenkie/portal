<table border="0" cellpadding="0" cellspacing="2" id="scrolltb">
	<tr>
		...
		<td style="min-width: 150px;text-align: right;">
			...
			<%= PortletUtils.getMessage(pageContext, "show-page-number-end",null)%>
			<!--
			...
			*/
			...
			<span><%= PortletUtils.getMessage(pageContext, "article",null)%></span>
			<select id="currentpage" class="currentpage" onChange="pc.scrollPage('.customrange','topage',this)"></select>
			<span><%= PortletUtils.getMessage(pageContext, "page",null)%></span>
		</td>
	</tr>
</table>
<script>
