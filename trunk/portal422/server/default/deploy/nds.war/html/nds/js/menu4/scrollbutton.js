...
ScrollButton.prototype.detachEvents = function () {
	...
	try{this.htmlElement.detachEvent( "onmouseover", this.eventListeners.onmouseover );}catch(ex){}
	try{this.htmlElement.detachEvent( "onmouseout", this.eventListeners.onmouseout );}catch(ex){}
	try{window.detachEvent( "onunload", this.eventListeners.onunload );}catch(ex){}
};
