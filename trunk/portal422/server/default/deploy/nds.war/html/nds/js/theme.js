...
if(jQuery){
	jQuery(function(){
		var middleHeight = jQuery(window).height() - jQuery("#portal_top").height() - jQuery("#portal-bottom").height();
		jQuery("#portal_top").css("position","static");
		jQuery("#portal_middle").css("height",middleHeight+"px").css("position","static");
		jQuery("#portal-bottom").css("position","relative");
	});
}