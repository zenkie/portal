...
<td id="begin_btn" onaction="gc.scrollPage('begin_btn')"><img src="<%=NDS_PATH%>/images/begin.gif" width="16" height="16"></td>
<td id="prev_btn" onaction="gc.scrollPage('prev_btn')"><img src="<%=NDS_PATH%>/images/back.gif" width="16" height="16"></td>
<td id="next_btn" onaction="gc.scrollPage('next_btn')"><img src="<%=NDS_PATH%>/images/next.gif" width="16" height="16"></td>
<td id="end_btn" onaction="gc.scrollPage('end_btn')"><img src="<%=NDS_PATH%>/images/end.gif" width="16" height="16"></td>
<td>
