...
<%
	...
	String content1 = "";
	if(joTuwen!=null && joTuwen.has("content") && joTuwen.get("content")!=null){
		content1 = String.valueOf(joTuwen.get("content"));
	}
	String title1 = "";
	if(joTuwen!=null && joTuwen.has("title") && joTuwen.get("title")!=null){
		title1 = String.valueOf(joTuwen.get("title"));
	}
	String imgsrc = "";
	if(joTuwen!=null && joTuwen.has("url") && joTuwen.get("url")!=null){
		imgsrc = String.valueOf(joTuwen.get("url"));
	}
...
<script type="text/javascript">
	...
	function changeOp(){
		...
		if(arra[se].SHOW_DC==null && arra[se].FIFTLE_CONDITION==null){
			...
			var arr=JSON.stringify(select);
			jQuery.post("/html/nds/oto/rqcode/addMenu_goodstable.jsp",
					{"arr":arr,"sid":0},
					function(data){
					jQuery('#goodsTable').html(data);
				}
	...
	function changSelection(){
		...
		jQuery.post("/html/nds/oto/rqcode/addMenu_tbody.jsp",
	...
	function submitMessage(){
		...
		tuWen.fromid=fromid;
		tuWen.objid=sigleid;
		tuWen.title=txtTitle;
		tuWen.url=grouponimage;
		tuWen.content=description;
