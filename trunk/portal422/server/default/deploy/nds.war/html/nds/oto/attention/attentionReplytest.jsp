...
<link type="text/css" href="/html/nds/oto/attention/css/emotiontest.css" rel="Stylesheet">
<script language="javascript" src="/html/nds/js/prototype.js"></script>
<script language="javascript" src="/html/nds/oto/attention/js/attentionReply.js"></script>
<script type="text/javascript" src="/html/nds/oto/attention/js/jquery.qqFacetest.js"></script>
                                    ...
                                    <div class="replyList">
                                        ...
                                        <div id="divRelpys" class="replyItems showWords showFile showAppMsg">
                                            <div id="divRelpyWords" style="height: 350px;">
												...
												<div id="txtReplyWords" contenteditable="true" style="overflow-y: auto; overflow-x: hidden;"></div>
