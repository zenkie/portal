...
<div id="container" class="<%=ssId!=-1?"cl":""%>">
	<div id="portal_top" class="<%=ssId!=-1?"sub_top":"top"%>">
		...
		<div class="top_right">
			...
			<label>
				<input type="button" title="知识库" class="top-button top-button-hover" onclick="javascript:showObject('http://bcp.burgeon.cn:8090/dashboard.action;jsessionid=9EC89B07A058BF26432AC55788A84713',null,null)" style=" background: url(/images/newimages/home_top_7.png) no-repeat left top;" />
				<!--<a href="#">
					<img title="设置" onclick="javascript:showObject('/html/nds/option/option.jsp',null,null)" src="/images/newimages/home_top_3.png" />
				</a>-->
			</label>
