...
<body style="background: url('/servlets/binserv/Image?image=apt') !important">
    ...
    <body>
        ...
        <%
			...
			SubSystem ss;
		%>
		<div class="index-right-content fade-down">
					...
					<div class="icon-wrap sub-system">
						<ul class="icon">
							...
							<li onclick="javascript:pc.ssv(<%=ss.getId()%>)">
								...
								<a href="javascript:ssv.view(44)"><%=ss.getName()%></a>
								<img class="icon-img" src="<%=ss.getIconURL()%>" style="display: none" />
							</li>
							<%}%>
			...
			<!--右侧新闻动态-->
		<div class="newslist Main_interface_cont_right right-in delay-half">
