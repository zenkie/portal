...
function($) {
	...
	function serializeData(e) {
		...
		e.data && (!e.type || e.type.toUpperCase() == "GET") && (e.url = appendQuery(e.url, e.data), e.data = null)
	}
...
function(e, t) {
	...
	e.each(o,
	function(e, i) {
		if (a.style[e + "TransitionProperty"] !== t) return n = "-" + e.toLowerCase() + "-",
		r = i,
		!1
	}),
	l = n + "transform",
	b[c = n + "transition-property"] = b[h = n + "transition-duration"] = b[d = n + "transition-delay"] = b[p = n + "transition-timing-function"] = b[v = n + "animation-name"] = b[m = n + "animation-duration"] = b[y = n + "animation-delay"] = b[g = n + "animation-timing-function"] = "",
	e.fx = {
	...
	e.fn.anim = function(n, r, i, s, o) {
		...
		N = e.fx.animationEnd;
			...
			S && (a[l] = S, E.push(l)),
			r > 0 && typeof n == "object" && (a[c] = E.join(", "), a[h] = r + "s", a[d] = o + "s", a[p] = i || "linear")
		}
		return T = function(t) {
...
var loadlazy; (function() {
	loadlazy = {
		init: function() {
			var e = this;
			e.onerrorImgUrl = "http://s.mb-go.com/pub7/style/images/grey.gif",
			e.srcStore = "original",
			e.class = "lazy",
			e.sensitivity = 100,
			minScroll = 5,
			...
			isIos = e.isPhone = isIos && isoVersion < 6;
			if (isIos) {
				var t,
				n;
				...
				function(r) {
					if (r && r.changedTouches) {
						var i = Math.abs(window.scrollY - t.sy);
						if (i > minScroll) {
							var s = Date.now() - t.time;
		...
		trigger: function() {
			var e = this;
			eventType = e.isPhone && "touchend" || "scroll",
			e.imglist = $("img." + e.class + ""),
		...
		changeimg: function() {
			function e(e) {
				...
				i = e.offset().top;
				return i >= t && i - n.sensitivity <= r
			}
			function t(e, t) {
				var r = e.attr(n.srcStore);
				e.attr("src", r),
				e[0].onload || (e[0].onload = function() {
					$(this).removeClass(n.class).removeAttr(n.srcStore),
					n.imglist[t] = null,
					this.onerror = this.onload = null
				},
				e[0].onerror = function() {
					this.src = n.onerrorImgUrl,
					$(this).removeClass(n.class).removeAttr(n.srcStore),
					n.imglist[t] = null,
					this.onerror = this.onload = null
				})
			...
			var n = this;
			n.imglist.each(function(r, i) {
				if (!i) return;
				var s = $(i);
				if (!e(s)) return;
				if (!s.attr(n.srcStore)) return;
				t(s, r)
			})
		}
	}
...
function Swipe(e, t) {
	...
	function h() {
		o = s.children,
		f = o.length,
		o.length < 2 && (t.continuous = !1),
		i.transitions && t.continuous && o.length < 3 && (s.appendChild(o[0].cloneNode(!0)), s.appendChild(s.children[1].cloneNode(!0)), o = s.children),
		...
		while (n--) {
			...
			i.transitions && (r.style.left = n * -a + "px", g(n, l > n ? -a: l < n ? a: 0, 0))
		}
		t.continuous && i.transitions && (g(v(l - 1), -a, 0), g(v(l + 1), a, 0)),
		i.transitions || (s.style.left = l * -a + "px"),
	...
	k = {
		...
		start: function(e) {
			...
			C = undefined,
			N = {},
			s.addEventListener("touchmove", this, !1),
			s.addEventListener("touchend", this, !1)
		},
		move: function(e) {
			...
			typeof C == "undefined" && (C = !!(C || Math.abs(N.x) < Math.abs(N.y))),
			C || (e.preventDefault(), x(), t.continuous ? (y(v(l - 1), N.x + u[v(l - 1)], 0), y(l, N.x + u[l], 0), y(v(l + 1), N.x + u[v(l + 1)], 0)) : (N.x = N.x / (!l && N.x > 0 || l == o.length - 1 && N.x < 0 ? Math.abs(N.x) / a + 1: 1), y(l - 1, N.x + u[l - 1], 0), y(l, N.x + u[l], 0), y(l + 1, N.x + u[l + 1], 0)))
		},
		end: function(e) {
			var n = +(new Date) - T.time,
			r = Number(n) < 250 && Math.abs(N.x) > 20 || Math.abs(N.x) > a / 2,
			i = !l && N.x > 0 || l == o.length - 1 && N.x < 0;
			t.continuous && (i = !1);
			var f = N.x < 0;
			C || (r && !i ? (f ? (t.continuous ? (g(v(l - 1), -a, 0), g(v(l + 2), a, 0)) : g(l - 1, -a, 0), g(l, u[l] - a, c), g(v(l + 1), u[v(l + 1)] - a, c), l = v(l + 1)) : (t.continuous ? (g(v(l + 1), a, 0), g(v(l - 2), -a, 0)) : g(l + 1, a, 0), g(l, u[l] + a, c), g(v(l - 1), u[v(l - 1)] + a, c), l = v(l - 1)), t.callback && t.callback(l, o[l])) : t.continuous ? (g(v(l - 1), -a, c), g(l, 0, c), g(v(l + 1), a, c)) : (g(l - 1, -a, c), g(l, 0, c), g(l + 1, a, c))),
			s.removeEventListener("touchmove", k, !1),
			s.removeEventListener("touchend", k, !1)
		},
