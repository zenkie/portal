...
<%
	...
	String firOrSecFlg = request.getParameter("firOrSecFlg");
	int imagewidth=200;
	int imageheight=200;
	if("0".equals(firOrSecFlg)){imagewidth=360;}
...
function changeOpFir(){
	var se = document.getElementById("jumpType").value;
	var former;
	var arra=<%=menuArr%>;
	var sid="<%=sid%>";
