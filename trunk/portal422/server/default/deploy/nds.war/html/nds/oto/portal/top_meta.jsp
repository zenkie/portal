...
<script language="javascript1.5" src="/html/nds/oto/js/ieemu.js"></script>
...
<!--script language="javascript" src="/html/nds/oto/js/portletcontrol.js"></script-->
<script language="javascript" src="/html/nds/oto/js/init_portalcontrol_<%=locale.toString()%>.js"></script>
<script language="javascript" src="/html/nds/oto/js/portalcontrol.js"></script>
<script language="javascript" src="/html/nds/oto/js/object_query.js"></script>
<script language="javascript" src="/html/nds/oto/js/categorymenu.js"></script>
<script language="javascript" src="/html/nds/oto/js/dockmenu.js"></script>
<script language="javascript" src="/html/nds/oto/js/outline.js"></script>
<script language="javascript" src="/html/nds/oto/js/jdate/My97DatePicker/WdatePicker.js"></script>
<!--script language="javascript" src="/html/nds/oto/js/flyout/flyout.ribbon.min.js"></script-->

<!--[if IE]><script language="javascript" src="/html/nds/oto/js/jquery1.3.2/jquery.bgiframe.js"></script><![endif]-->
<!--script language="javascript" src="/html/nds/oto/js/jquery1.3.2/ui.core.js"></script>
<script language="javascript" src="/html/nds/oto/js/jquery1.3.2/ui.dialog.js"></script>
<script language="javascript" src="/html/nds/oto/js/jquery1.3.2/ui.draggable.js"></script>
<script language="javascript" src="/html/nds/oto/js/jquery1.3.2/ui.resizable.js"></script>

<script language="javascript" src="/html/nds/oto/js/jquery1.3.2/ui.tabs.js"></script>
<script language="javascript" src="/html/nds/oto/js/messagescontrol.js"></script-->
<!--script language="javascript" src="/html/nds/oto/js/jquery1.3.2/jquery.bgiframe.js"></script-->
<!--script language="javascript" src="/html/nds/oto/js/jquery1.3.2/jquery-ui-1.7.3.custom.min.js"></script-->
...
<script type="text/javascript" src="/html/nds/oto/js/imgbox/jquery.imgbox.js"></script>
<script type="text/javascript" src="/html/nds/oto/js/menuoperation.js"></script>
<script type="text/javascript" src="/html/nds/oto/js/zeroclipboard/ZeroClipboard.js"></script>


<!--link type="text/css" rel="stylesheet" href="/html/nds/oto/js/artdialog4/skin/chrome.css" /-->
<link type="text/css" rel="stylesheet" href="/html/nds/oto/js/xloadtree111/xtree.css" />
<!--link type="text/css" rel="StyleSheet" href="/html/nds/oto/css/portlet.css"-->
...
<link type="text/css" rel="stylesheet" href="/html/nds/oto/js/imgbox/imgbox.css"/>

<!--link type="text/css" rel="StyleSheet" href="/html/nds/oto/js/flyout/flyout.ribbon.css"></script-->
<!--link type="text/css" rel="StyleSheet" href="<%=userWeb.getThemePath()%>/css/jquery-ui-1.7.3.custom.css" /-->
<!--link type="text/css" rel="stylesheet" href="/html/nds/oto/themes/ui-lightness/ui.all.css" /-->
